...
export const RestaurantCard = ({ cardData }) => {
  const { info } = cardData;
  return (
    <article className="card rounded-md shadow-md peer-hover:scale105 overflow-hidden hover:scale-105 transition-transform duration-300 ease-in-out bg-grey100 text-grey700 flex flex-col justify-between">
      <Link
